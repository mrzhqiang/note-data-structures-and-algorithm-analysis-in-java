...
public class Crossword extends Application {
  ...
  @FXML TableView<Letter> crosswordTable;
  @FXML TableColumn<Letter, String> indexColumn;
  @FXML TableColumn<Letter, String> oneColumn;
  @FXML TableColumn<Letter, String> twoColumn;
  @FXML TableColumn<Letter, String> threeColumn;
  @FXML TableColumn<Letter, String> fourColumn;
  ...
  private enum Direction {
    NORTH {
      @Override boolean find(List<Letter> letterList, String word, int x, int y) {
