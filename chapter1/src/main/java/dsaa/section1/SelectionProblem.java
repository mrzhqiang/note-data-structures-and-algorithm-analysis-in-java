...
public class SelectionProblem extends Application {
  ...
  public void initialize() {
    console("初始化程序..");
    filename = String.format("result-%s.md", ISO_LOCAL_DATE.format(LocalDateTime.now()));
  ...
  private boolean checkNumber(String value) {
    ...
    return CharMatcher.digit().matchesAllOf(numberText);
  }
